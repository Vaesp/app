...
public class MembreteHeaderiText2 extends PdfPageEventHelper {
    public void onStartPage(PdfWriter writer, Document document) {
        try
        {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_CENTER, new Phrase("Plantilla de embarcaciones " + fecha, font7), 400,556,0);
